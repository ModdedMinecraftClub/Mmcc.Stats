    ...
    {:then res}
        ...
        >
            <div id="weekly-trends">
                <h2
                    class="my-2 text-lg ml-1 text-gray-300 uppercase tracking-wide"
                >
                    Weekly trends
                </h2>
                <WeeklyTrendsCard
                    pingsWeeklyAvgs={res.pingsAvgs}
                    tpsWeeklyAvgs={res.tpsAvg}
                />
            </div>
            <div id="charts">
                <h2
                    class="mt-12 mb-2 text-lg ml-1 text-gray-300 uppercase tracking-wide"
                >
                    Charts
                </h2>
                <div
                    class="flex flex-col gap-4 lg:grid lg:grid-cols-2 lg:gap-x-8"
                >
                    <PlayerbaseChartCard {pingsClient} />
                    <TpsChartCard {tpsClient} />
                </div>
            </div>
        </div>
    {:catch}
